...
helper
  playPauseAndUpdate(player.playPause(song));
  update total setTimeout(function () {

  }, replace every call of player.playPause with helper.playPause);
}



//Create class Helper and instantiate class as variable helper.
//Add method to Helper called playPauseAndUpdate that takes
//parameter song
//method should call player.playPause (passing the song parameter)
//and update total time.
